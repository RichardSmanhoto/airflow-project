...
class BigDataOperator(BaseOperator):
    template_fields = (
        "path_to_csv_file", "path_to_save_file", "separator", "file_type"
    )
    
    def __init__(self, *, path_to_csv_file: str, path_to_save_file: str, separator: str = ";", file_type: str = 'parquet', **kwargs) -> None:
